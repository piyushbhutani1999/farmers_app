...
urlpatterns = [
    ...
    path("tools-and-instruments/",product_list_view_elec, name = 'electronics'),
    path("jobs/",product_list_view_jobs, name = 'jobs'),
    path("farm-machinery/",product_list_view_vehicles, name = 'vehicles'),
    path("others/",product_list_view_others, name = 'others'),
    path("fertilizers/",product_list_view_roomdecor, name = 'roomdecor'),
    path("seeds/",product_list_view_stationary, name = 'stationary'),
